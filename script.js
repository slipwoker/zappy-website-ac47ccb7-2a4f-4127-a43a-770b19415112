document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      if (hasErrors) {
        ...
        showFormMessage(contactForm, 'Please fix the errors above before submitting.', 'error');
        return;
      }

      // If form has a data-ajax attribute, handle via fetch
      if (contactForm.hasAttribute('data-ajax')) {
        e.preventDefault();
        ...
        fetch(action, {
          ...
          .then(function () {
            showFormMessage(contactForm, 'Thank you! Your message has been sent.', 'success');
            contactForm.reset();
          })
          .catch(function () {
  ...
  const visibleClass = 'fade-in-visible';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'ac47ccb7-2a4f-4127-a43a-770b19415112',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'ac47ccb7-2a4f-4127-a43a-770b19415112';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'ac47ccb7-2a4f-4127-a43a-770b19415112';
